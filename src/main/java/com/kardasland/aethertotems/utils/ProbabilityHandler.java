...
public class ProbabilityHandler {
	...
	public ProbabilityHandler(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public ProbabilityHandler setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public ProbabilityHandler setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public ProbabilityHandler debug() {
		debug = true;
		return this;
	}

	public boolean register() {
		log(0, "[]==========[License-Sistemi]==========[]");
		log(0, "Lisans sunucusuna bağlanılıyor...");
		ValidationType vt = isValid();
		if (vt == ValidationType.VALID) {
			log(1, "Lisans geçerli!");
			log(0, "[]==========[License-Sistemi]==========[]");
			return true;
		} else {
			log(1, "Lisans geçersiz!");
			log(1, "Hata kodu: " + vt.toString());
			log(1, "Eklenti devre dışı!");
			log(0, "[]==========[License-Sistemi]==========[]");
